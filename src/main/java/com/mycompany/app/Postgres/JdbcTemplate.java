...
public class JdbcTemplate extends PostgresDriver {
    ...
    public ResultSet query(String sqlQuery) throws PostgresDatabaseConnectionError {
        ...
        try {
            ...
            try {
                ...
                throw new PostgresDatabaseConnectionError(e1.getMessage());
    ...
    public <T> T queryForSingleObject(
        ...
        try (
                Connection conn = createConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
